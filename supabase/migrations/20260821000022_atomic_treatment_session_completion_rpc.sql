-- Migration: Atomic Treatment Session Completion RPC
-- Spec Reference: GOAL SESSION-GOV1B2 — Atomic Database RPC for Clinical Treatment Session Completion
...
BEGIN
    ...
    -- 10. Update Appointment to COMPLETED
    ...
    RETURN jsonb_build_object(
        ...
        'planned_session_count', v_course_planned,
        'course_status', v_new_course_status,
        'message', 'Hoàn tất buổi trị liệu thành công.'
    );
END;
$$;
