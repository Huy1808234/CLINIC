-- Migration: 20260825000034_atomic_reception_intake_rpc.sql
-- Goal: RECEPTION-ATOMIC-INTAKE1-RPC34
-- Spec Reference: Atomic Reception Intake, Patient Creation, Insurance, Measurements, Reception, and Treatment Course
...
BEGIN
    ...
    -- 4. Validate actor has active membership and RECEPTIONIST/ADMIN/MANAGER role at p_clinic_id
    ...
    WHERE scm.staff_id = p_actor_staff_id
      ...
      AND scr.role_code IN ('RECEPTIONIST', 'ADMIN', 'MANAGER');
